...
const IndexPage = () => (
  <div>
    ...
    <Section
      ...
      text="Learn how to build a modern site using React and the most efficient libraries to get your site/product online. The course covers the full React stack."
     />
     <SectionCaption>12sections - 6 hours</SectionCaption>
     <SectionCellGroup>
